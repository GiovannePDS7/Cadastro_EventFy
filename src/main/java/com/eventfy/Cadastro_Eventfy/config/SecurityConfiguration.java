...
public class SecurityConfiguration {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        .requestMatchers("/organizadores/**").permitAll() // Permite acesso à rota
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        config.setAllowedOrigins(List.of("https://event-fy.vercel.app/cadastro", "http://localhost:4200", "https://cadastroeventfy-production.up.railway.app/organizadores/cadastro"));// Permite o frontend Angular
